...
$PARAMETERS['database']['username'] = 'nonamegdr';            //nome utente del database
$PARAMETERS['database']['password'] = '';            //password del database
$PARAMETERS['database']['database_name'] = 'my_nonamegdr';    //nome del database
...
$PARAMETERS['info']['site_name'] = 'Carnem et Umbrae'; //nome del gioco
$PARAMETERS['info']['site_url'] = 'https://nonamegdr.altervista.org/'; //indirizzo URL del gioco
$PARAMETERS['info']['webmaster_name'] = 'Staff'; //nome e cognome del responsabile del sito
 ...
 *
 */
$PARAMETERS['themes']['kind_of_layout'] = 'left-top';
...
$PARAMETERS['left_column']['box']['quick_menu']['class'] = 'menu';
$PARAMETERS['left_column']['box']['quick_menu']['page'] = 'link_menu';
$PARAMETERS['left_column']['box']['quick_menu']['menu_key'] = 'quick_menu';
...
$PARAMETERS['left_column']['box']['quick_menu']['no_gotomap_list'] = true;

/*TOP PAGE*/
$PARAMETERS['top_column']['box']['main_menu']['class'] = 'menu_top';
$PARAMETERS['top_column']['box']['main_menu']['page'] = 'link_menu';
$PARAMETERS['top_column']['box']['main_menu']['menu_key'] = 'main_menu';
$PARAMETERS['top_column']['box']['main_menu']['no_gotomap_list'] = true;


/* NOMI CHIAVE DEL GIOCO */
$PARAMETERS['names']['users_name']['sing'] = 'Ombra'; //nome singolare degli utenti
$PARAMETERS['names']['users_name']['plur'] = 'Ombre'; //nome plurale degli utenti
$PARAMETERS['names']['currency']['sing'] = 'Lira'; //nome singolare della valuta nel gioco
$PARAMETERS['names']['currency']['plur'] = 'Lire'; //nome plurale della valuta nel gioco
$PARAMETERS['names']['currency']['short'] = 'L.'; //nome breve della valuta nel gioco
$PARAMETERS['names']['private_message']['sing'] = 'Lettera'; //nome dei messaggi privati tra utenti (singolare)
$PARAMETERS['names']['private_message']['plur'] = 'Lettere'; //nome dei messaggi privati tra utenti (plurale)
...
$PARAMETERS['names']['status']['sing'] = 'Status'; //nome delle razze nel gioco (singolare)
$PARAMETERS['names']['status']['plur'] = 'Status'; //nome delle razze nel gioco (plurale)
$PARAMETERS['names']['race']['lead'] = 'Caporazza'; //nome del capo razza nel gioco (plurale)
$PARAMETERS['names']['master']['sing'] = 'Contador'; //titolo degli arbitri (singolare)
$PARAMETERS['names']['master']['plur'] = 'Contadori'; //titolo degli arbitri (plurale)
$PARAMETERS['names']['moderators']['sing'] = 'Diretor'; //titolo dei moderatori (singolare)
$PARAMETERS['names']['moderators']['plur'] = 'Diretori'; //titolo dei moderatori (plurale)
$PARAMETERS['names']['administrator']['sing'] = 'Capoccia'; //titolo del super user (singolare)
$PARAMETERS['names']['administrator']['plur'] = 'Capocce'; //titolo del super user (plurale)
$PARAMETERS['names']['gamemenu']['quick_menu'] = '';
$PARAMETERS['names']['gamemenu']['main_menu'] = '';
$PARAMETERS['names']['market_name'] = 'Mercato'; //Nome del mercato
$PARAMETERS['names']['maps_location'] = 'Venezia'; //Appare se il PG si trova su una mappa
$PARAMETERS['names']['base_location'] = 'Sò a spassarse'; //Appare nei presenti se non è possibile localizzare il pg
$PARAMETERS['names']['stats']['car0'] = 'Robustezza'; //Caratteristiche del personaggio nella scheda
$PARAMETERS['names']['stats']['car1'] = 'Destrezza';
$PARAMETERS['names']['stats']['car2'] = 'Percezione';
...
$PARAMETERS['date']['offset'] = -132;
$PARAMETERS['date']['base_temperature'] = -12;//temperatura minima assoluta in gradi.
 ...
 * @author Blancks
 */
$PARAMETERS['settings']['audio_new_messages'] = 'messaggi.mp3';
$PARAMETERS['settings']['audio_new_chat'] = 'chat.mp3';
 ...
 */
 ...
 /* VOCI DEL MENU */
 $PARAMETERS['quick_menu']['refresh']['text'] = 'Refresh';
 $PARAMETERS['quick_menu']['refresh']['url'] = 'main.php?dir=' . $_SESSION['luogo'];
 $PARAMETERS['quick_menu']['refresh']['image_file'] = 'refresh.png';
 $PARAMETERS['quick_menu']['refresh']['image_file_onclick'] = 'refresh-hover.png';
 
 $PARAMETERS['quick_menu']['quit']['text'] = 'Logout';
 $PARAMETERS['quick_menu']['quit']['url'] = 'logout.php';
 $PARAMETERS['quick_menu']['quit']['image_file'] = 'exit.png';
 $PARAMETERS['quick_menu']['quit']['image_file_onclick'] = 'exit-hover.png';

 $PARAMETERS['main_menu']['map']['text'] = 'Mappa';
$PARAMETERS['main_menu']['map']['url'] = 'main.php?page=mappaclick&map_id=' . $_SESSION['mappa'];
$PARAMETERS['main_menu']['map']['image_file'] = '';
$PARAMETERS['main_menu']['map']['image_file_onclick'] = '';

/*$PARAMETERS['main_menu']['profile']['text'] = 'Scheda';
$PARAMETERS['main_menu']['profile']['url'] = "javascript:modalWindow('scheda', 'Scheda di ". $_SESSION['login'] ."', 'popup.php?page=scheda&pg=". $_SESSION['login'] ."');";
$PARAMETERS['main_menu']['profile']['image_file'] = '';
$PARAMETERS['main_menu']['profile']['image_file_onclick'] = '';*/

if ($_SESSION['permessi'] >= MODERATOR) {
    $PARAMETERS['main_menu']['backend']['text'] = 'Gestione';
    $PARAMETERS['main_menu']['backend']['url'] = 'main.php?page=gestione';
    $PARAMETERS['main_menu']['backend']['image_file'] = '';
    $PARAMETERS['main_menu']['backend']['image_file_onclick'] = '';
}

$PARAMETERS['main_menu']['services']['text'] = 'Servizi';
$PARAMETERS['main_menu']['services']['url'] = 'main.php?page=uffici';
$PARAMETERS['main_menu']['services']['image_file'] = '';
$PARAMETERS['main_menu']['services']['image_file_onclick'] = '';

$PARAMETERS['main_menu']['user_services']['text'] = 'Menu utente';
$PARAMETERS['main_menu']['user_services']['url'] = 'main.php?page=utenti';
$PARAMETERS['main_menu']['user_services']['image_file'] = '';
$PARAMETERS['main_menu']['user_services']['image_file_onclick'] = '';
