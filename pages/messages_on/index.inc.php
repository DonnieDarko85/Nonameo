...
<div class="elenco_record_gioco">
    ...
    <?php
            ...
            <table>
                <tr>
                    ...
                    <td>
                        <span class="titoli_elenco">
                            <?php if($isSentMessage) {
                                ...
                                echo gdrcd_filter('out', $MESSAGE['interface']['messages_on']['sender']);
                            }
                            ?>
                        </span>
                    </td>
                    <td>
                        <span class="titoli_elenco">
                            ...
                            echo ($isSentMessage)
                                ? "Inviato il"
                                : gdrcd_filter('out', $MESSAGE['interface']['messages_on']['date']);
                            ?>
                        </span>
                    </td>
                    <td>
                        <span class="titoli_elenco">
                            <?php echo gdrcd_filter('out', $MESSAGE['interface']['messages_on']['type']['title']); ?>
                        </span>
                    </td>
                    <td>
                        <span class="titoli_elenco">
                            <?php echo gdrcd_filter('out', $MESSAGE['interface']['messages_on']['subject']); ?>
                        </span>
                    </td>
                    <td>
                        <span class="titoli_elenco">
                            <?php echo gdrcd_filter('out', $MESSAGE['interface']['messages_on']['preview']); ?>
                        </span>
                    </td>
                    <td>
                        <!-- Controlli -->
                ...
                while($row = gdrcd_query($result, 'fetch')) {
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="elementi_elenco">
                                ...
                                if($isSentMessage) {
                                    ...
                                    echo gdrcd_filter('out', $MESSAGE['interface']['messages_on']['to_guild']);
                                } else {
                        ...
                        <td>
                            <div class="elementi_elenco">
                                <?php echo gdrcd_format_date($data_spedito).'<br/>'.gdrcd_filter('out', $MESSAGE['interface']['messages_on']['time']).' '.gdrcd_format_time($ora_spedito); ?>
                            </div>
                        </td>
                        <td>
                            <div class="elementi_elenco">
                                <?php echo gdrcd_filter('out', $MESSAGE['interface']['messages_on']['type']['options'][$row['tipo']]); ?>
                            </div>
                        </td>
                        <td>
                            <div class="elementi_elenco">
                            ...
                            <div class="controlli_elenco">
                                <div class="controllo_elenco">
                                    ...
                                    <form action="main.php?page=messages_center<?php echo $isSentMessage ? '&op=inviati' : ''; ?>" method="post">
                                        ...
                                        <input type="image" src="imgs/icons/reply.png" value="submit" alt="<?php echo gdrcd_filter('out', $MESSAGE['interface']['messages_on']['reply']); ?>"
                                               title="<?php echo gdrcd_filter('out', $MESSAGE['interface']['messages_on']['reply']); ?>" />
                                    </form>
                                </div>
                                <div class="controllo_elenco">
                                    <!-- reply -->
                                    <form action="main.php?page=messages_center<?php echo $isSentMessage ? '&op=inviati' : ''; ?>" method="post">
                                        ...
                                        <input type="image" src="imgs/icons/erase.png" value="submit" alt="<?php echo gdrcd_filter('out', $MESSAGE['interface']['messages_on']['erase']); ?>"
                                               title="<?php echo gdrcd_filter('out', $MESSAGE['interface']['messages_on']['erase']); ?>" />
                                    </form>
                                </div>
                            </div>
                        </td>
        ...
        <?php
            ...
            echo '<div class="warning">'.gdrcd_filter('out', $MESSAGE['interface']['messages_on']['no_message']).'</div>';
        }
        ?>
    <div class="pager">
...
<div class="link_back">
    <a href="main.php?page=messages_center&op=create">
        <?php echo $MESSAGE['interface']['messages_on']['new']; ?>
    </a>
</div>
<script type="text/javascript">
    ...
    function checkedDelete() {
        ...
        let messages_on = document.getElementsByClassName('message_check');
        let n_msg = messages_on.length;
        let checked = false;

        let i;
        for (i = 0; i < n_msg; i++) {
            if (messages_on[i].checked) {
                checked = true;
                let el = document.createElement('input');
                el.setAttribute('type', 'hidden');
                el.setAttribute('name', 'ids[]');
                el.setAttribute('value', messages_on[i].getAttribute('value'));
                form.appendChild(el);
            }
        }
