...
/*TOP PAGE*/
$PARAMETERS['top_column']['box']['frame_messages']['class'] = 'messages';
$PARAMETERS['top_column']['box']['frame_messages']['page'] = 'frame_messages'; //Link ai messaggi
$PARAMETERS['top_column']['box']['frame_forum']['class'] = 'forums';
$PARAMETERS['top_column']['box']['frame_forum']['page'] = 'frame_forums'; //Link al forum
 ...
 */
 ...
 /* VOCI DEL MENU */
 $PARAMETERS['quick_menu']['refresh']['text'] = '';
 ...
 $PARAMETERS['quick_menu']['quit']['text'] = '';
...
$PARAMETERS['main_menu']['profile']['url'] = 'main.php?page=scheda&pg=' . $_SESSION['login'];
